...
try{
 ...
 console.log('Browser checks passed: desktop/mobile, search, live scenario detail, weather windows, report persistence, draft recovery, backup import/deduplication, XSS escaping, refresh failure and missing Leaflet.');
